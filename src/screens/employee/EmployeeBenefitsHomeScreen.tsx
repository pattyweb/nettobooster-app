// src/screens/employee/EmployeeBenefitsHomeScreen.tsx
...
import { EmployeeBenefitsStackParamList } from '../../navigation/EmployeeBenefitsStack';

if (Platform.OS === 'android' && UIManager.setLayoutAnimationEnabledExperimental) {
  UIManager.setLayoutAnimationEnabledExperimental(true);
}

type Props = StackScreenProps<EmployeeBenefitsStackParamList, 'EmployeeBenefitsHome'>;
...
export default function EmployeeBenefitsHomeScreen({ navigation }: Props) {
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.9}
          onPress={() => navigation.navigate('EmployeeBenefitsConfig')}
        >
